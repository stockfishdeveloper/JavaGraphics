...
class RectangularPrism extends JComponent implements MouseMotionListener, MouseListener
{
	int currx = 350;
	int curry = 350;
	...
	{
		p1.SetX(center.GetExX() - (length / 2));
		p1.SetY(center.GetExY() + (height / 2));
		p1.SetZ(center.GetExZ() - (width / 2));
		p2.SetX(center.GetExX() + (length / 2));
		p2.SetY(center.GetExY() + (height / 2));
		p2.SetZ(center.GetExZ() - (width / 2));
		p3.SetX(center.GetExX() - (length / 2));
		p3.SetY(center.GetExY() - (height / 2));
		p3.SetZ(center.GetExZ() - (width / 2));
		p4.SetX(center.GetExX() + (length / 2));
		p4.SetY(center.GetExY() - (height / 2));
		p4.SetZ(center.GetExZ() - (width / 2));
		p5.SetX(center.GetExX() - (length / 2));
		p5.SetY(center.GetExY() + (height / 2));
		p5.SetZ(center.GetExZ() + (width / 2));
		p6.SetX(center.GetExX() + (length / 2));
		p6.SetY(center.GetExY() + (height / 2));
		p6.SetZ(center.GetExZ() + (width / 2));
		p7.SetX(center.GetExX() - (length / 2));
		p7.SetY(center.GetExY() - (height / 2));
		p7.SetZ(center.GetExZ() + (width / 2));
