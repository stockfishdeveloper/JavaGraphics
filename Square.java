	...
	public void Draw_Mesh(BufferedImage buf)
	{
            //if(Should_Be_Drawn())
		{
            ...
            if(t != null)
            {
            	...
            	g.drawLine(t.points[2].GetX() + 640, t.points[2].GetY() + 500, t.points[3].GetX() + 640, t.points[3].GetY() + 500);
                g.drawLine(t.points[0].GetX() + 640, t.points[0].GetY() + 500, t.points[3].GetX() + 640, t.points[3].GetY() + 500);
            }
        }
	}
